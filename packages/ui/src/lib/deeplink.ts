 ...
 *
 *   ?tab=chat|mechanics|arcade|petitions|cosign   — the TryIt section
...
export type TabId = 'chat' | 'mechanics' | 'arcade' | 'petitions' | 'cosign'
export type ChatMode = 'public' | 'anonymous' | 'encrypted' | 'direct' | 'stealth'
export type DemoKind = 'encrypted' | 'direct'

const TABS: readonly TabId[] = ['chat', 'mechanics', 'arcade', 'petitions', 'cosign']
