...
import { makeWorkerBoard } from '../src/seams/worker-board.js'
import type { WorkerRequestMsg, WorkerResponseMsg } from '../src/worker/types.js'
 ...
 * (mirrors packages/ui's identical fixture) — the real grind is a Web Worker concern, not
 * something this headless test can execute, but this proves the seam's addMessage/`content`
 * plumbing (posting, cleanup, progress forwarding, error propagation) is correct.
 */
class FakeWorker {
