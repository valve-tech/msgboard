...
/** allowed rpc url patterns — only msgboard-enabled endpoints are proxied (mirrors packages/cosign-web) */
 ...
 * reach directly from an https page (mixed-content). Copied from packages/cosign-web's proxy so a
