...
/**
 * Main-thread `BoardClient` (the petition seam) that drives the Web-Worker PoW grind.
 *
 ...
 * client is reused. Adopted verbatim from packages/cosign-web's `makeWorkerBoard`.
 */
