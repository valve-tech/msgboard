...
// Source: examples/games/zk-skill/circuits/wordle_clue.circom (circom -> snarkjs 0.7.6 PLONK).
...
contract WordleCluePlonkVerifier {
    // Omega
    ...
    uint256 constant Qmx  = 19204061119618940519232471174599505099576345795098220467379762599081556974443;
    uint256 constant Qmy  = 8053668611035716915631985889037289371967778863139965734082636350665525055628;
    uint256 constant Qlx  = 9630360092361542735475643906111907481463438375640257466490304968064574866967;
    uint256 constant Qly  = 12872290359754325894144637543301856148189451820725675827052352163493094674341;
    uint256 constant Qrx  = 9711645260905732759735865544724579208015259011351251271203307678918690511478;
    uint256 constant Qry  = 4821862688860053465916660338252092454177513104622237119343211981546780633893;
    uint256 constant Qox  = 10789707509183734703478597301248953781454094027922465995628842416597869631177;
    uint256 constant Qoy  = 14352824537973066136404277796030671751518932674546829615498785003556303653894;
    uint256 constant Qcx  = 10311565746867689485561853305901045229928916764352393810869155511163454072680;
    uint256 constant Qcy  = 11385679080048430663486281304402766843722341391707099165272955636800634790855;
    uint256 constant S1x  = 18723053606811949397214115842825857482756424714141743595855396422215585685110;
    uint256 constant S1y  = 12895197121605242384920414022274621223176655597287285585945557440615151522494;
    uint256 constant S2x  = 5416150703393298762724459775014024819895023117805657024137129122163392563612;
    uint256 constant S2y  = 5635498675430184395930132757163991269156799822987509508316594166527405052483;
    uint256 constant S3x  = 1174616055846543210949369431070462372746761074356977600997142365686723295497;
    uint256 constant S3y  = 17919719412093121357825243885105637916551711326319849027327532964393858111021;
