...
import init, { stamp as stamp } from '@msgboard/pow-grinder/wasm'
...
self.onmessage = async (e: MessageEvent<Job>) => {
  ...
  try {
    ...
    await ready
    // version 1 — the one and only message version, hashed into the scalar transcript. stamp requires it.
